...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
    ...
    const login = async (email: string, password: string) => {
        const response = await axios.post<{ accessToken: string; user: User }>(`${process.env.REACT_APP_API_URL}/api/login`, {
            email,
            password,
        });
    ...
    const register = async (eamil: string, name: string, password: string) => {
